...
export class HomeComponent  implements OnInit{
  ...
  ngOnInit() {
    ...
    this.images = [
      ...
      new ImageItem({ src: 'https://cdn.akamai.steamstatic.com/apps/csgo/images/csgo_react/social/cs2.jpg', thumb: 'https://cdn.akamai.steamstatic.com/apps/csgo/images/csgo_react/social/cs2.jpg' }),
